...
public interface INodeProcessor
{
    ...
    /// WordNodeProcessor has a weight of 1, since only one token can ever fit here. <br/>
    /// On the other hand, RepeatingWildCardNodeProcessor has positive infinity, since it will capture
    /// everything left.
    /// </summary>
    uint Weight { get; }
